    ...
    <section className="mb-12 bg-white dark:bg-gray-800 p-6 rounded-lg shadow-lg transition-colors duration-200">
      ...
      <div className="flex flex-col md:flex-row gap-6 items-start mb-6">
        ...
        <p className="text-gray-600 dark:text-gray-300 leading-relaxed">
          Graduado em Tecnologia da Informação e pós-graduado em Engenharia de Software, sou um profissional com
          experiência em desenvolvimento de software, gestão de projetos e liderança de equipes. Especializado em
